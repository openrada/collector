...
(deftest check-registrations
  ...
  (testing "Parse Parasiuk"
    (let [registrations (registrations/parse-member-registrations "http://w1.c1.rada.gov.ua/pls/radan_gs09/ns_dep_reg_list?startDate=27.11.2014&endDate=12.01.2015&kod=87")]
